...
std::vector<SpecInfo> const& GetAllSpecs()
{
    ...
    { 1, 0, "武器", "近战DPS", ROLE_DPS,
      ...
      {   // buffs
        { 6673, SF_SELF|SF_BUFF_KEEP, "战斗怒吼" },
        { 2457, SF_SELF|SF_BUFF_KEEP, "战斗姿态" },
        { 50720, SF_SELF|SF_BUFF_KEEP, "警戒" },
      },
      {   // tankKit
    ...
    { 1, 1, "狂怒", "近战DPS", ROLE_DPS,
      ...
      {   // buffs
        { 6673, SF_SELF|SF_BUFF_KEEP, "战斗怒吼" },
        { 2458, SF_SELF|SF_BUFF_KEEP, "狂暴姿态" },
        { 50720, SF_SELF|SF_BUFF_KEEP, "警戒" },
      },
      {   // tankKit
    ...
    { 1, 2, "防护", "坦克", ROLE_TANK,
      ...
      {   // buffs
        { 71, SF_SELF|SF_BUFF_KEEP, "防御姿态" },
        { 469, SF_SELF|SF_BUFF_KEEP, "命令怒吼" },
        { 1160, SF_AOE, "挫志怒吼" },
        { 50720, SF_SELF|SF_BUFF_KEEP, "警戒" },
      },
      {   // tankKit
    ...
    { 2, 0, "神圣", "治疗", ROLE_HEALER,
      ...
      {   // buffs
        ...
        { 465, SF_SELF|SF_BUFF_KEEP, "虔诚光环" },
        { 54428, SF_SELF, "神圣恳求" },
        { 25894, SF_SELF|SF_BUFF_KEEP, "强效智慧祝福" },
    ...
    { 2, 1, "防护", "坦克", ROLE_TANK,
      ...
      {   // buffs
        { 20911, SF_SELF|SF_BUFF_KEEP, "庇护祝福" },
        { 465, SF_SELF|SF_BUFF_KEEP, "虔诚光环" },
    ...
    { 2, 2, "惩戒", "近战DPS", ROLE_DPS,
      ...
      {   // buffs
        { 31801, SF_SELF|SF_BUFF_KEEP, "复仇圣印" },
        { 25782, SF_SELF|SF_BUFF_KEEP, "强效力量祝福" },
        { 7294, SF_SELF|SF_BUFF_KEEP, "惩戒光环" },
        { 25898, SF_SELF|SF_BUFF_KEEP, "强效王者祝福" },
    ...
    { 3, 0, "野兽掌握", "远程DPS", ROLE_DPS,
      ...
      {   // buffs
        { 13165, SF_SELF|SF_BUFF_KEEP, "雄鹰守护" },
        { 1130, SF_DEBUFF_KEEP, "猎人印记" },
        { 19506, SF_SELF|SF_BUFF_KEEP, "强击光环" },
        { 34074, SF_SELF|SF_MANA_LOW, "蝰蛇守护" },
      },
      {   // tankKit
    ...
    { 3, 2, "生存", "远程DPS", ROLE_DPS,
      ...
      {   // buffs
        { 61846, SF_SELF|SF_BUFF_KEEP, "巨龙鹰守护" },
        { 1130, SF_DEBUFF_KEEP, "猎人印记" },
        { 19506, SF_SELF|SF_BUFF_KEEP, "强击光环" },
        { 34074, SF_SELF|SF_MANA_LOW, "蝰蛇守护" },
      },
    ...
    { 4, 0, "刺杀", "近战DPS", ROLE_DPS,
      ...
      {   // buffs
        { 2823, SF_SELF|SF_BUFF_KEEP, "致命毒药" },
        { 8679, SF_SELF|SF_BUFF_KEEP, "速效毒药" },
        { 13219, SF_SELF|SF_BUFF_KEEP, "致伤毒药" },
      },
      {   // tankKit
    ...
    { 5, 0, "戒律", "治疗", ROLE_HEALER,
      {   // rotation
        { 47540, SF_NONE, "苦修" },
        { 17, SF_BUFF_KEEP, "真言术盾" },
        { 2061, SF_NO_MOVE, "快速治疗" },
        { 139, SF_DEBUFF_KEEP, "恢复" },
        { 2060, SF_NO_MOVE, "强效治疗" },
        { 33076, SF_NONE, "愈合祷言" },
        { 596, SF_NO_MOVE|SF_AOE, "治疗祷言" },
        { 585, SF_NO_MOVE, "惩击" },
      },
      {   // burst
        { 10060, SF_SELF, "能量灌注" },
    ...
    { 5, 1, "神圣", "治疗", ROLE_HEALER,
      ...
      {   // burst
        { 64843, SF_SELF|SF_NO_MOVE, "神圣赞美诗" },
        { 14751, SF_SELF, "心灵专注" },
        { 10060, SF_SELF, "能量灌注" },
      },
      {   // defensive
    ...
    { 6, 0, "鲜血", "坦克", ROLE_TANK,
      ...
      {   // buffs
        { 48266, SF_SELF|SF_BUFF_KEEP, "鲜血领域" },
    ...
    { 6, 1, "冰霜", "近战DPS", ROLE_DPS,
      ...
      {   // buffs
        { 48263, SF_SELF|SF_BUFF_KEEP, "冰霜领域" },
        { 57330, SF_SELF|SF_BUFF_KEEP, "寒冬号角" },
      },
      {   // tankKit
    ...
    { 6, 2, "邪恶", "近战DPS", ROLE_DPS,
      ...
      {   // buffs
        { 48265, SF_SELF|SF_BUFF_KEEP, "邪恶领域" },
        { 57330, SF_SELF|SF_BUFF_KEEP, "寒冬号角" },
        { 49222, SF_SELF|SF_BUFF_KEEP, "白骨之盾" },
      },
      {   // tankKit
    ...
    { 7, 0, "元素", "远程DPS", ROLE_DPS,
      ...
      {   // buffs
        { 324, SF_SELF|SF_BUFF_KEEP, "闪电之盾" },
        { 3599, SF_SELF, "灼热图腾" },
        { 30706, SF_SELF, "愤怒图腾" },
        { 8024, SF_SELF|SF_BUFF_KEEP, "火舌武器" },
        { 3738, SF_SELF, "风怒图腾" },
        { 5675, SF_SELF, "法力之泉图腾" },
      },
      {   // tankKit
    ...
    { 7, 1, "增强", "近战DPS", ROLE_DPS,
      ...
      {   // buffs
        { 324, SF_SELF|SF_BUFF_KEEP, "闪电之盾" },
        { 8232, SF_SELF|SF_BUFF_KEEP, "风怒武器" },
        { 8075, SF_SELF, "大地之力图腾" },
        { 8512, SF_SELF, "风怒图腾" },
        { 8227, SF_SELF, "火舌图腾" },
        { 3599, SF_SELF, "灼热图腾" },
    ...
    { 7, 2, "恢复", "治疗", ROLE_HEALER,
      {   // rotation
        { 61295, SF_DEBUFF_KEEP, "激流" },
        { 8004, SF_NO_MOVE, "次级治疗波" },
        { 1064, SF_NO_MOVE|SF_AOE, "治疗链" },
        { 331, SF_NO_MOVE, "治疗波" },
        { 974, SF_BUFF_KEEP, "大地之盾" },
        { 8050, SF_DEBUFF_KEEP, "烈焰震击" },
        { 403, SF_NO_MOVE, "闪电箭" },
      },
      {   // burst
      ...
      {   // buffs
        { 52127, SF_SELF|SF_BUFF_KEEP, "水之护盾" },
        { 51730, SF_SELF|SF_BUFF_KEEP, "大地之赐武器" },
        { 5675, SF_SELF, "法力之泉图腾" },
        { 8075, SF_SELF, "大地之力图腾" },
        { 8512, SF_SELF, "风怒图腾" },
        { 5394, SF_SELF, "治疗之泉图腾" },
    ...
    { 8, 0, "奥术", "远程DPS", ROLE_DPS,
      ...
      {   // buffs
        { 30482, SF_SELF|SF_BUFF_KEEP, "熔岩护甲" },
        { 1459, SF_SELF|SF_BUFF_KEEP, "奥术智慧" },
        { 1008, SF_SELF|SF_BUFF_KEEP, "强化法术" },
    ...
    { 8, 2, "冰霜", "远程DPS", ROLE_DPS,
      ...
      {   // buffs
        { 7302, SF_SELF|SF_BUFF_KEEP, "寒冰护甲" },
        { 1459, SF_SELF|SF_BUFF_KEEP, "奥术智慧" },
        { 604, SF_SELF|SF_BUFF_KEEP, "法术抑制" },
        { 54646, SF_SELF|SF_BUFF_KEEP, "魔法专注" },
      },
      {   // tankKit
    ...
    { 9, 0, "痛苦", "远程DPS", ROLE_DPS,
      ...
      {   // buffs
        { 28176, SF_SELF|SF_BUFF_KEEP, "魔誓防护" },
        { 54424, SF_SELF|SF_BUFF_KEEP, "地狱智慧" },
    ...
    { 11, 0, "平衡", "远程DPS", ROLE_DPS,
      ...
      {   // buffs
        { 24858, SF_SELF|SF_BUFF_KEEP, "枭兽形态" },
        { 1126, SF_SELF|SF_BUFF_KEEP, "野性印记" },
        { 467, SF_SELF|SF_BUFF_KEEP, "尖刺" },
      },
      {   // tankKit
    ...
    { 11, 3, "恢复", "治疗", ROLE_HEALER,
      {   // rotation
        { 33763, SF_BUFF_KEEP, "生命之花" },
        { 774, SF_DEBUFF_KEEP, "回春术" },
        { 48438, SF_AOE, "野性成长" },
        { 18562, SF_NONE, "迅捷治愈" },
        { 50464, SF_NO_MOVE, "滋养" },
        { 8936, SF_NO_MOVE, "愈合" },
        { 5185, SF_NO_MOVE, "治疗之触" },
        { 8921, SF_DEBUFF_KEEP, "月火术" },
      },
      {   // burst
        { 740, SF_SELF|SF_NO_MOVE, "宁静" },
        { 17116, SF_SELF, "自然迅捷" },
        { 29166, SF_SELF, "激活" },
      },
      {   // defensive
      ...
      {   // buffs
        { 33891, SF_SELF|SF_BUFF_KEEP, "树形态" },
        { 1126, SF_SELF|SF_BUFF_KEEP, "野性印记" },
        { 467, SF_SELF|SF_BUFF_KEEP, "尖刺" },
      },
      {   // tankKit
