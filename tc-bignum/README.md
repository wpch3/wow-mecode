...
新增交付（2026-08-18 第二十三批）· 坐骑配额修正【我的失误】：
  ...
  修正: Class.Misc = 8 (三行约14888件, 比用户原值还多57%)
...
第二十二批实测结果（2026-08-18 用户回报）：
  拍卖行 [通过] Alliance/Horde/Neutral 各39498, 共118494条(目标39700/行, 完成度99.5%)
                金色战刃已消失, 其他物品丰富
  台词   [通过] 141条
  时间线 [通过] 能看到
...
新增交付（2026-08-09 第十五批）：
  G19 第3步 场景感知【已g++验证+逻辑测试6项全过】
...
新增交付（2026-08-09 第二批）：
  ...
  G17 全世界飞行 + 御龙术
    规划/G17_飞行与移动/01-全世界飞行方案.md
    三道门全部实证。.learn 34090 34091 54197 立刻见效
  全局审视
