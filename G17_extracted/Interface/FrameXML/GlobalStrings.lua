...
CALENDAR_FILTERS = "过滤";
CALENDAR_FILTER_BATTLEGROUND = "战场节日";
...
CHAT_NOT_IN_LFG_NOTICE = "[%s] 你必须在寻求组队的队列中才能加入此频道。";
...
CHAT_OFFICER_GET = "|Hchannel:o|h[官员]|h %s：\32";
...
CONFIRM_LFG_REMOVE_LAST_ROLE = "移除你的最后一项职责将会导致你退出所有的寻求组队序列。你确定要移除最后一项职责吗？";
...
ENCN = "简体中文（英文语音）";
ENCRYPTED = "已加密";
END_BOUND_TRADEABLE = "执行此项操作会使该物品变为不可交易品。";
...
ERR_MATCHMAKING_AUTOJOIN_FAILED_NO_PLAYER = "匹配到的玩家已下线。";
...
ERR_MATCHMAKING_OTHER_TIMEDOUT = "因等待其他玩家的时间过长，配组已超时。";
ERR_MATCHMAKING_PARTY_KICKED_FROM_QUEUE = "一个队友已经被移除，全队已从集合石队列中移除。";
ERR_MATCHMAKING_PENDING_INVITE_S = "寻求组队系统将你加入了一支%s的队伍。";
ERR_MATCHMAKING_PENDING_MATCH_S = "寻求组队系统正在等待完成%s的配组。";
ERR_MATCHMAKING_SUCCESS = "你的小队组建完成，你已经退出自动配组系统。";
ERR_MATCHMAKING_TIMEDOUT = "配组超时。";
...
FAR = "远";
FARCLIP = "视野距离";
FEATURES_LABEL = "特征|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
FEATURES_SUBTEXT = "这些选项可以让你开启或关闭游戏的全部特征。";
...
FULL_SIZE_FOCUS_FRAME_TEXT = "扩大焦点框架|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
GM_RESPONSE_POPUP_MUST_RESOLVE_RESPONSE = "请先阅读当前GM响应。";
...
GM_RESPONSE_POPUP_VIEW_RESPONSE = "查看响应";
...
HELPFRAME_GMTALK_TEXT2 = "另外，我们鼓励所有的玩家首先选择论坛和官方网站来寻找相关问题的解决信息，网址是|cffffd200www.warcraftchina.com|r。并请仔细阅读我们的游戏条款，网址是：|cffffd200http://www.warcraftchina.com/cs/policy/|r";
...
IMMUNE = "免疫";
INBOX = "收件箱";
INBOX_TOO_MUCH_MAIL = "你并没有收到全部的邮件。|n请删除部分邮件以释放邮箱空间。";
INCOMPLETE = "未完成";
...
INSTANCE_ID = "副本ID：%d";
INSTANCE_LEAVE = "离开副本";
INSTANCE_LOCK_TIMER = "你进入了一个已经保存进度的副本！你将在%2$s!内被保存到%1$s的副本进度中！";
...
ITEMS = "|4物品:件物品;";
ITEMSLOTTEXT = "物品栏位";
ITEMS_EQUIPPED = "已装备%d |4item:件物品;";
ITEMS_IN_INVENTORY = "背包中有%d |4item:件物品;";
ITEMS_NOT_IN_INVENTORY = "缺少%d |4item:件物品;";
...
ITEM_REQ_ARENA_RATING_3V3 = "需要3v3或5v5的个人竞技场等级和战队竞技场等级达到%d|nin";
ITEM_REQ_ARENA_RATING_5V5 = "需要5v5的个人竞技场等级和战队竞技场等级达到%d|nin";
...
ITEM_SLOTS_IGNORED = "略过%d |4slot:个插槽;";
...
NO_RESPONSE = "无回复";
NO_ROLE_SELECTED = "在加入寻求组队或招募队员的队列之前，你必须选择至少一种你所担当的职责。";
...
OBJECTIVES_LABEL = "目标|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
OBJECTIVES_VIEW_IN_QUESTLOG = "打开任务记录";
...
OPTION_TOOLTIP_FULL_SIZE_FOCUS_FRAME = "将焦点框架的尺寸扩大到与目标框架相同。";
...
PRESS_TAB = "简讯标签";
PREV = "上一页";
PREVIEW_TALENT_CHANGES = "预览天赋改变|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
PREVIOUS = "返回";
...
PVP_OPTIONS = "PvP";
PVP_POLICY_URL = "|cffffd200http://www.warcraftchina.com/cs/policy/pvp|r";
PVP_RANK_0_0 = "斥候";
...
SHOW_ITEM_LEVEL = "显示物品等级|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
SHOW_QUEST_OBJECTIVES_ON_MAP_TEXT = "在地图上显示任务目标|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
SINGLE_PAGE_RESULTS_TEMPLATE = "%d 物品";
SKILL = "技能";
SKILLS = "技能";
SKILLS_ABBR = "技能";
SKILLUPS = "技能提升";
...
TUTORIAL31 = "你已经拥有了一块炉石，它可以将你从现在的位置传送回你最后登记的那个旅店里。你每30分钟只能使用一次炉石。";
...
TUTORIAL47 = "你可以使用图腾栏了！以后每当你获得一个新的图腾元素，图腾栏上就会出现对应的按钮。每种图腾元素只能放置一个图腾法术快捷键，另外还有一个特殊按钮可以让你同时施放所有图腾栏上的法术。";
...
UNITFRAME_LABEL = "单位框体|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
...
USE_EQUIPMENT_MANAGER = "启用装备管理|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t";
