...
INSTALL = ROOT / "sql/G17B0_world_install_v2_locked.sql"
CHECK = ROOT / "sql/G17B0_world_postcheck_v2_readonly.sql"
ROLLBACK = ROOT / "sql/G17B0_world_rollback_v2_owned_only.sql"
PACKAGE = PLAN / "G17B0_World_Install_20260822"
ZIP = PLAN / "G17B0_World_Install_20260822.zip"
ZIP_SIZE = 10310
ZIP_SHA256 = "d5e5535569342b88836e0f13e8a79e5edaa9faa0ee640d132ce9ff7bc035750a"
TOP = "G17B0_World_Install_20260822"
...
require((PACKAGE / "01_G17B0_world_install_v2_locked.sql").read_bytes() == INSTALL.read_bytes(),
        "delivery install SQL")
require((PACKAGE / "02_G17B0_world_postcheck_v2_readonly.sql").read_bytes() == CHECK.read_bytes(),
        "delivery postcheck SQL")
require((PACKAGE / "99_G17B0_world_rollback_v2_owned_only.sql").read_bytes() == ROLLBACK.read_bytes(),
        "delivery rollback SQL")
checksum_lines = (PACKAGE / "SHA256SUMS.txt").read_text(encoding="utf-8").splitlines()
require(len(checksum_lines) == 8, "delivery checksum count")
seen = set()
...
with zipfile.ZipFile(ZIP) as archive:
    ...
    require(len(infos) == 9, "delivery ZIP file count")
    for info in infos:
...
print("G17B0_WORLD_INSTALL_V2_LEXICAL=PASS")
print("G17B0_WORLD_INSTALL_V2_ONE_RESULT_TABLE=True")
print("G17B0_WORLD_INSTALL_V2_TRANSACTION=PASS")
print("G17B0_WORLD_INSTALL_V2_EXACT_GATES=PASS")
print("G17B0_WORLD_POSTCHECK_V2_READ_ONLY=PASS")
print("G17B0_WORLD_ROLLBACK_V2_OWNED_ONLY=PASS")
print("G17B0_WORLD_INSTALL_INTERNAL_CHECKSUMS=PASS_8")
print("G17B0_WORLD_INSTALL_ZIP=FINAL_PASS")
