...
EXTRA_BUFF = {
 ...
 # 法师：补法术强化/法术抑制/魔法专注
 (8,0): [(1008,'SF_RAID_BUFF|SF_BUFF_KEEP','强化法术'),
         (54646,'SF_MAINTAIN_FRIEND|SF_BUFF_KEEP','魔法专注')],
 (8,1): [(1008,'SF_RAID_BUFF|SF_BUFF_KEEP','强化法术'),
         (54646,'SF_MAINTAIN_FRIEND|SF_BUFF_KEEP','魔法专注')],
 (8,2): [(604,'SF_RAID_BUFF|SF_BUFF_KEEP','法术抑制'),
         (54646,'SF_MAINTAIN_FRIEND|SF_BUFF_KEEP','魔法专注')],
