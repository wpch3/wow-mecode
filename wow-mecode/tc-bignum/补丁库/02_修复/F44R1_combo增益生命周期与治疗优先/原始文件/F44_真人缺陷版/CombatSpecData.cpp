...
std::vector<SpecInfo> const& GetAllSpecs()
{
    ...
    { 2, 0, "神圣", "治疗", ROLE_HEALER,
      ...
      {   // buffs
        { 25782, SF_RAID_BUFF|SF_BUFF_KEEP, "强效力量祝福" },
        { 465, SF_SELF|SF_BUFF_KEEP, "虔诚光环" },
        { 54428, SF_SELF, "神圣恳求" },
        { 25894, SF_RAID_BUFF|SF_BUFF_KEEP, "强效智慧祝福" },
        { 25898, SF_RAID_BUFF|SF_BUFF_KEEP, "强效王者祝福" },
    ...
    { 2, 1, "防护", "坦克", ROLE_TANK,
      ...
      {   // buffs
        { 20911, SF_RAID_BUFF|SF_BUFF_KEEP, "庇护祝福" },
        { 465, SF_SELF|SF_BUFF_KEEP, "虔诚光环" },
    ...
    { 3, 0, "野兽掌握", "远程DPS", ROLE_DPS,
      ...
      {   // buffs
        ...
        { 34477, SF_MAINTAIN_FRIEND|SF_BUFF_KEEP, "误导" },
      },
      {   // tankKit
    ...
    { 4, 0, "刺杀", "近战DPS", ROLE_DPS,
      ...
      {   // buffs
        ...
        { 57934, SF_MAINTAIN_FRIEND|SF_BUFF_KEEP, "嫁祸诀窍" },
      },
      {   // tankKit
    ...
    { 8, 0, "奥术", "远程DPS", ROLE_DPS,
      ...
      {   // buffs
        ...
        { 1008, SF_RAID_BUFF|SF_BUFF_KEEP, "强化法术" },
    ...
    { 8, 2, "冰霜", "远程DPS", ROLE_DPS,
      ...
      {   // buffs
        ...
        { 1459, SF_RAID_BUFF|SF_BUFF_KEEP, "奥术智慧" },
        { 604, SF_RAID_BUFF|SF_BUFF_KEEP, "法术抑制" },
        { 54646, SF_MAINTAIN_FRIEND|SF_BUFF_KEEP, "魔法专注" },
      },
      {   // tankKit
               ...
               bool allSpecs, BuiltPlan& out)
{
    ...
    for (SpecInfo const* sp : use)
    {
        // ---- 增益：所有职责都要；稳定友方维护也只进入opener ----
        AppendUnique(out.opener, sp->buffs);
        for (Skill const& s : sp->healKit)
            if (s.flags & SF_MAINTAIN_FRIEND)
                AppendUnique(out.opener, { s });
