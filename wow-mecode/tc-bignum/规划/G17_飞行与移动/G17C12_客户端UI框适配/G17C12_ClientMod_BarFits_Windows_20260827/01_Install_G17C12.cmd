...
echo.
powershell.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%~dp0Install-G17C12-ClientMod.ps1" %*
set "RC=%ERRORLEVEL%"
echo.
if not "%RC%"=="0" (
  echo [G17C12] INSTALL FAILED.
) else (
  echo [G17C12] INSTALL PASSED. Restart the WoW client.
)
pause
exit /b %RC%
