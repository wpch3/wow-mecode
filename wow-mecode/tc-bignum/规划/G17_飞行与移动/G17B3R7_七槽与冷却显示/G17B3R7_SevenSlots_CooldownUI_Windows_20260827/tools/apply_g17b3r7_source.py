#!/usr/bin/env python3
"""G17-B3R7 source apply tool: seven-slot vehicle pages + vehicle cooldown UI packets.

Locked-lineage installer for cs_dragonriding.cpp, same contract as B3R6:
  check    - report the target's lineage state (no writes)
  apply    - forensic-backup + atomic write of the B3R7 postimage
  rollback - atomic write of the safety-rollback image (B3R6 floor)

Lineage:
  PRE      3fdb46e8...  B3R6 performance fix (user current)
  POST     f2360d7e...  B3R7 seven slots + cooldown packets
  ROLLBACK 3fdb46e8...  undo B3R7 -> back to the deployed B3R6 build
All earlier G17 images remain valid upgrade sources.
"""
...
PRE_SHA256 = "3fdb46e89a03a521d641b285a15339619a43b68c6399938121fb24683dfd306b"   # B3R6 (user current)
POST_SHA256 = "f2360d7e1be3ccea66f8bd499b19d4a7cc04acadee804dedbf8bf6774e3ca38c" # B3R7 seven slots + cooldown UI packets
...
INTERMEDIATE12_SHA256 = "3fdb46e89a03a521d641b285a15339619a43b68c6399938121fb24683dfd306b" # B3R6 final (user current)
SAFE_ROLLBACK_SHA256 = "3fdb46e89a03a521d641b285a15339619a43b68c6399938121fb24683dfd306b"
