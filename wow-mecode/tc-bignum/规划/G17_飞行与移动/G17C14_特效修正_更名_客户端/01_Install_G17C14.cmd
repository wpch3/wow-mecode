...
echo.
powershell.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%~dp0Install-G17C14-ClientDBC.ps1" %*
set "RC=%ERRORLEVEL%"
echo.
if not "%RC%"=="0" (
  echo [G17C14] INSTALL FAILED.
) else (
  echo [G17C14] INSTALL PASSED. Restart the WoW client.
)
pause
exit /b %RC%
