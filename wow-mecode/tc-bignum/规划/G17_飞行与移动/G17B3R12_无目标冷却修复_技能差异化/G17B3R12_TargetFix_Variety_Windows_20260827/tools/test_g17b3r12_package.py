...
TOOL = PKG / "tools" / "apply_g17b3r12_source.py"
INSTALL_PS1 = PKG / "Install-Build-G17B3R12-Windows.ps1"
...
def t4_payload_content():
    ...
    ok("T4 bounded diff (added<=150, removed<=45)", len(added) <= 320 and len(removed) <= 60,
