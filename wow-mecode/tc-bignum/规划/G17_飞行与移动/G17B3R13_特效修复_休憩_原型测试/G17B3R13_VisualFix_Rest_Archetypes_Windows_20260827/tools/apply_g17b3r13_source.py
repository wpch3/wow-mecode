#!/usr/bin/env python3
"""G17-B3R13 source apply tool: swoop rename + dragon rest + archetype test.

Locked-lineage installer for cs_dragonriding.cpp, same contract as B3R6-R12:
  check    - report the target's lineage state (no writes)
  apply    - forensic-backup + atomic write of the B3R13 postimage
  rollback - atomic write of the safety-rollback image (B3R6 floor)

Lineage:
  PRE      a6074cde...  B3R12 r12a (user current)
  POST     c051fcda...  B3R13 rest + archetype test + rename
...
PRE_SHA256 = "a6074cde399875ecc6741647bee57ca11a0f5785ab784fd3fe265aa0e1fd54ee"   # B3R12 r12a (user current)
POST_SHA256 = "c051fcdadeb8dadabd1f1d295c89ef798728d2c932da4792dcb0ad41d8a1d269" # B3R13 rest + archetype test + rename
...
INTERMEDIATE19_SHA256 = "3d501d9bb4b0ca2cb7f553877d6d32f85217e85723caf4602e5ad2863c74bcca" # B3R12 r1
INTERMEDIATE20_SHA256 = "a6074cde399875ecc6741647bee57ca11a0f5785ab784fd3fe265aa0e1fd54ee" # B3R12 r12a (user current)
...
UPGRADEABLE_SHAS = (INTERMEDIATE_SHA256, INTERMEDIATE2_SHA256, INTERMEDIATE3_SHA256,
                    ...
                    INTERMEDIATE19_SHA256, INTERMEDIATE20_SHA256)
