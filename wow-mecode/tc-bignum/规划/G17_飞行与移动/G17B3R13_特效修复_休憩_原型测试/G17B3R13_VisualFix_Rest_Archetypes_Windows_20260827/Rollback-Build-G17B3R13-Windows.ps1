...
$Result = Join-Path $UploadDir "G17B3R13_ROLLBACK_RESULT.txt"
...
try {
    ...
    W "G17B3R13_ROLLBACK_RESULT=PASS"
    exit 0
} catch {
    W ("G17B3R13_ROLLBACK_ERROR=" + $_.Exception.Message)
    W "G17B3R13_ROLLBACK_RESULT=FAIL"
    exit 1
}
