#!/usr/bin/env python3
"""G17-B3R9 source apply tool: full player-cast support for the custom DragonRide UI.

Locked-lineage installer for cs_dragonriding.cpp, same contract as B3R6-R8:
  check    - report the target's lineage state (no writes)
  apply    - forensic-backup + atomic write of the B3R9 postimage
  rollback - atomic write of the safety-rollback image (B3R6 floor)

Lineage:
  PRE      dcfa78dd...  B3R8 (if installed)
  POST     f0564c5a...  B3R9 player-cast UI support
  ROLLBACK 3fdb46e8...  undo everything -> back to the deployed B3R6 build
B3R6/B3R7/B3R8 are ALL valid upgrade sources (whichever the user has).
"""
...
POST_SHA256 = "f0564c5ad225a67f0e49477d31d6939d32b490e6d69b8218f122bc7dce5560c3" # B3R9 player-cast UI support
...
INTERMEDIATE14_SHA256 = "dcfa78dd92ac4491882b9e2ec5c18a8b0803d6fcbb01cbe553e7fc069ac0f487" # B3R8 (may be the user's current state)
...
UPGRADEABLE_SHAS = (INTERMEDIATE_SHA256, INTERMEDIATE2_SHA256, INTERMEDIATE3_SHA256,
                    ...
                    INTERMEDIATE13_SHA256, INTERMEDIATE14_SHA256)
