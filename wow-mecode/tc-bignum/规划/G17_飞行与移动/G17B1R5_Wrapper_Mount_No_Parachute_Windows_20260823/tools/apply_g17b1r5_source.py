...
PRE_SHA256 = "e9418704731a2d9cd5119cc2024079a2326802796d00bf24e88928dd17ea7059"
POST_SHA256 = "35af002b09b5d8112bbc1aaa1750f4a6245adec8b7c91a7852d69bdd283668b8"
...
def atomic_write(path: Path, data: bytes) -> None:
    temporary = path.with_name(path.name + ".g17b1r5.tmp")
    if temporary.exists():
...
def check(root: Path) -> str:
    ...
    print(f"G17B1R5_SOURCE_STATE={state}")
...
def apply(root: Path) -> None:
    ...
    if state == "ALREADY_APPLIED":
        print("G17B1R5_SOURCE_APPLY=ALREADY_CURRENT")
        return
    backup = target.with_name(target.name + ".g17b1r5.preimage")
    if backup.exists():
    ...
    print("G17B1R5_SOURCE_APPLY=PASS")
