...
class TestPatcher(unittest.TestCase):
    ...
    def test_08_installer_state_write_is_idempotent(self):
        ...
        install = (ROOT / "Install-Build-G17B2R4-Server-DBC.ps1").read_text(encoding="utf-8")
        rollback = (ROOT / "Rollback-Build-G17B2R4-Server-DBC.ps1").read_text(encoding="utf-8")
