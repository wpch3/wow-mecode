#!/usr/bin/env python3
"""G17-B3R10 source apply tool: eight filled slots per page, switch pinned at slot 8.

Locked-lineage installer for cs_dragonriding.cpp, same contract as B3R6-R9:
  check    - report the target's lineage state (no writes)
  apply    - forensic-backup + atomic write of the B3R10 postimage
  rollback - atomic write of the safety-rollback image (B3R6 floor)

Lineage:
  PRE      dcfa78dd...  B3R8 (the user's verified current state)
  POST     199cff4a...  B3R10 eight slots + switch@8 + chat feedback
  ROLLBACK 3fdb46e8...  undo everything -> back to the deployed B3R6 build
B3R6/B3R7/B3R8/B3R9 are ALL valid upgrade sources (payload includes all B3R9
dual-caster improvements, so one install brings every lineage up to date).
"""
...
PRE_SHA256 = "dcfa78dd92ac4491882b9e2ec5c18a8b0803d6fcbb01cbe553e7fc069ac0f487"   # B3R8 (if installed)
POST_SHA256 = "199cff4a8073f60634ae30b3a4c5fed9a6f90d7fab60fe4ece4d6d263a8fe3fe" # B3R10 eight slots + switch@8
...
INTERMEDIATE15_SHA256 = "f0564c5ad225a67f0e49477d31d6939d32b490e6d69b8218f122bc7dce5560c3" # B3R9 (if installed)
