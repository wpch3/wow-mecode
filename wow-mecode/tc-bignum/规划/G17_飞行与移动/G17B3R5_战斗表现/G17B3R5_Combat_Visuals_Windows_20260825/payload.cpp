...
void AddSC_dragonriding_commandscript()
{
    ...
    TC_LOG_INFO("server.loading",
        ">> G17-B3R5 combat visuals LOADED: SpellVisual carriers (C6), real mount auto-casts (generator), level-scaled damage, 30yd ranges; G17DragonBar addon v3 (diagnostics)");
}
