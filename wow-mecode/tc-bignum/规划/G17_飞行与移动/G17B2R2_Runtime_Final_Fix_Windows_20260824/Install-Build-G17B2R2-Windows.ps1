...
$Result = Join-Path $UploadDir "G17B2R2_WINDOWS_BUILD_RESULT.txt"
...
try {
    ...
    W "SCOPE=SKILL2_LAYERED_AUDITED_VISUALS_SKILL3_FACING_DASH_SKILL4_52226_CHECKCAST_AFTERCAST_BANNER"
    W "RUNS_SQL=True"
    W "DATABASE=world"
    ...
    W "G17B2R2_WINDOWS_BUILD_RESULT=PASS"
    ...
    W ("G17B2R2_WINDOWS_BUILD_ERROR=" + $_.Exception.Message)
    W "G17B2R2_WINDOWS_BUILD_RESULT=FAIL"
