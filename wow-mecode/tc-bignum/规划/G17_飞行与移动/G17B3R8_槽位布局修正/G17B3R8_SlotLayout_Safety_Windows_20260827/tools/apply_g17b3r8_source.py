#!/usr/bin/env python3
"""G17-B3R8 source apply tool: slot-layout safety fix (page switch back to slot 6).

Locked-lineage installer for cs_dragonriding.cpp, same contract as B3R6/R7:
  check    - report the target's lineage state (no writes)
  apply    - forensic-backup + atomic write of the B3R8 postimage
  rollback - atomic write of the safety-rollback image (B3R6 floor)

Lineage:
  PRE      f2360d7e...  B3R7 (if installed)
  POST     dcfa78dd...  B3R8 slot-layout safety fix
  ROLLBACK 3fdb46e8...  undo everything -> back to the deployed B3R6 build
B3R6 (3fdb46e8) and B3R7 (f2360d7e) are BOTH valid upgrade sources: if the
user never installed B3R7, B3R8 applies directly from B3R6.
"""
...
PRE_SHA256 = "f2360d7e1be3ccea66f8bd499b19d4a7cc04acadee804dedbf8bf6774e3ca38c"   # B3R7 (if installed)
POST_SHA256 = "dcfa78dd92ac4491882b9e2ec5c18a8b0803d6fcbb01cbe553e7fc069ac0f487" # B3R8 slot-layout safety fix
...
INTERMEDIATE13_SHA256 = "f2360d7e1be3ccea66f8bd499b19d4a7cc04acadee804dedbf8bf6774e3ca38c" # B3R7 (may be the user's current state)
